...
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://pkg.go.dev/google.golang.org/grpc/?tab=doc#ClientConn.NewStream.
//
// Возвращает массив объектов с данными доступных моделей. Описание доступных моделей в разделе [Модели GigaChat](/ru/gigachat/models/main).
...
func (UnimplementedModelsServiceServer) RetrieveModel(context.Context, *RetrieveModelRequest) (*RetrieveModelResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method RetrieveModel not implemented")
}
